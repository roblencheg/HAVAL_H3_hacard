...
[![GitHub Release](https://img.shields.io/github/v/release/anomalyco/haval-h3-dashboard-card)](https://github.com/anomalyco/haval-h3-dashboard-card/releases)
[![HACS Validation](https://github.com/anomalyco/haval-h3-dashboard-card/actions/workflows/build.yml/badge.svg)](https://github.com/anomalyco/haval-h3-dashboard-card/actions/workflows/build.yml)
...
3. Add `https://github.com/anomalyco/haval-h3-dashboard-card` as a custom repository of type **Lovelace**
...
1. Download the latest `haval-h3-dashboard-card.zip` from [releases](https://github.com/anomalyco/haval-h3-dashboard-card/releases)
2. Extract the `.js` file into your `config/www/` directory
...
|---|---|
| `sensor.engine_state` | Engine state |
| `sensor.security_mode` | Security/alarm mode |
| `sensor.fuel_level` | Fuel level |
| `sensor.mileage` | Mileage (km) |
| `sensor.battery_voltage` | Battery voltage |
| `sensor.engine_temperature` | Engine coolant temp |
| `sensor.cabin_temperature` | Cabin temperature |
| `sensor.outdoor_temperature` | Outdoor temperature |
| `sensor.left_side_temperature` | Left side temp (disabled by default) |
| `sensor.right_side_temperature` | Right side temp (disabled by default) |
| `sensor.location_speed` | GPS speed (km/h) |
| `sensor.location_course` | GPS course (degrees, disabled by default) |
| `sensor.last_update` | Last data update timestamp |
| `binary_sensor.ignition` | Ignition on/off |
| `binary_sensor.hood` | Hood open/closed |
| `binary_sensor.door_front_left` | Front left door |
| `binary_sensor.door_front_right` | Front right door |
| `binary_sensor.door_back_left` | Rear left door |
| `binary_sensor.door_back_right` | Rear right door |
| `binary_sensor.trunk` | Trunk open/closed |
| `binary_sensor.engine_running` | Engine running |
...
- Entity IDs may vary if you have multiple instances of an integration
